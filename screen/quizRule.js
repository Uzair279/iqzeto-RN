...
<Image source={require("../assets/navbar.png")}
      ...
      <Text style={styles.newButton}>Quiz Rules</Text>
      </View>
      <View style={{backgroundColor:'white',marginRight:1,}}>
      <View style={styles.padTop}>
      <View style={styles.pickedDateContainer}>
              
              <Text style={styles.pickedDate}>1:Why do we use it?</Text>
              <Text style={styles.stlishText}>It is a long established fact that a reader will be distracted by the readable content of page
              when looking as its layout.The point of using Lorem lpsum.</Text>
              <Text style={styles.pickedDate}>2:Where does it come from?</Text>
              <Text style={styles.stlishText}>Contrary to popular belief, Lorem lpsum is not simply random text. It has roots in a piece
              of classical Latin literature from 45 BC, making it over 2000 years old.</Text>
              <Text style={styles.pickedDate}>3:Where can i get some?</Text>
              <Text style={styles.stlishText}>There are many variations of passages of Lorem lpsum available, but the majority have
              suffered alteration in some form, but injected humour.</Text>
              </View>
  ...
  <View style={{backgroundColor:'white', borderBottomLeftRadius:9,borderBottomRightRadius:9,margin:5,
      ...
      <TouchableOpacity style={styles.NewOpacity} onPress={() => navigation.push("PrizePool")}>
