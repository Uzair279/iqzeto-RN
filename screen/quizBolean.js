...
function QuizBolean({ navigation }) {
    useEffect(() => {
      ...
      <View style={styles.blueView}>
       <View style={styles.blueBack}>
        ...
        <View style={styles.squareDirection}>
              ...
              <Text style={[styles.squre,{backgroundColor: "#3EC78D",}]}></Text>
              </View>
              </View>
              <View style={styles.squareDirection}>
           
              <TextInput placeholder='Linear combination' placeholderTextColor='black' style={[styles.textinput,{borderColor:'#E46351'}]}></TextInput>
              <View style={styles.squareButton}>
              <Text style={[styles.squre,{backgroundColor: "#E46351",}]}></Text>
        ...
        <View style={styles.buttonView}>
            ...
            <TouchableOpacity style={styles.Touchable} onPress={() => navigation.push("Question")}>
