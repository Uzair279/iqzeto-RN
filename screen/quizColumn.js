...
function QuizColumn({ navigation }) {
    useEffect(() => {
      ...
      <View style={styles.blueView}>
       <View style={styles.blueBack}>
        ...
        <View style={styles.circle}>
            ...
            <Text style={styles.lightBlueText}>Drag the Column B to match the statements in Column A</Text>
           
        </View>
        <Text style={styles.simpleView}>Rearrange column B</Text>
   
        <View style={styles.columnView}>
        <Text style={styles.columnText}>Column A</Text>    
        ...
        <View style={styles.squareDirection}>
              ...
              <View style={styles.columnView}>
        <Text style={styles.columnText}>Column B</Text>    
        <View style={styles.pad}>
        <TouchableOpacity style={styles.touch}>
            <Text style={styles.opt}>Option</Text>
        </TouchableOpacity>
        ...
        <View style={styles.buttonView}>
            ...
            onPress={() => navigation.push("QuizBolean")}>
